package com.example.choiceproperties_sales.repository.impl;
...
import com.example.choiceproperties_sales.repository.FirebaseTemplateRepository;
...
public class LeedRepositoryImpl extends FirebaseTemplateRepository implements LeedRepository {
    ...
    @Override
    public void updateUser(String leedId, Map leedMap, final CallBack callBack) {
    ...
    @Override
    public void updatePlot(String leedId, Map leedMap, final CallBack callBack) {
        final DatabaseReference databaseReference = Constant.SOLD_PLOT_TABLE_REF.child(leedId);
        fireBaseUpdateChildren(databaseReference, leedMap, new CallBack() {
            @Override
            public void onSuccess(Object object) {
                callBack.onSuccess(object);
    ...
    @Override
    public void updateRequest(String leedId, Map leedMap, final CallBack callBack) {
